...
#Ref: http://rstudio-pubs-static.s3.amazonaws.com/33754_4d463ac84bd24721bb9fe6a707ef6236.html
...
#}
#trigramSplitList <- strsplit(wordFrameTrigram$word," ")
#wordFrameTrigram$start <- sapply(trigramSplitList,FUN=function(x) paste(x[1],x[2]))
#wordFrameTrigram$end <- sapply(trigramSplitList,FUN=function(x) x[3]) 
